...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-[#121152] via-[#38476b] to-[#ffc1ac] text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        >
          ...
          >
            <span>Özel Topluluğumuza Katılın</span>
